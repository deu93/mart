@extends('layouts.app')
@section('content')
  <div class="login-style bg-gray-200">
    <div class="flex justify-center">
        <div class="w-6/12 bg-blue-100 p-6 rounded-lg">
            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirm a password" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('password_confirmation') border-red-500 @enderror">
